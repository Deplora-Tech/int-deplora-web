...
import { initializeModelList } from "@/app/utils/constants";
import FilePreview from "./FilePreview";
import styles from "./BaseChat.module.scss";
import { ModelInfo } from "@/app/utils/types";
import { SendButton } from "./SendButton.client";
import * as Tooltip from "@radix-ui/react-tooltip";
import { ProviderInfo } from "@/app/types/model";
...
export const BaseChat = React.forwardRef<HTMLDivElement, BaseChatProps>(
  (
      ...
      if (window.SpeechRecognition || window.webkitSpeechRecognition) {
        ...
        recognitionInstance.onresult = (event: any) => {
          ...
          if (handleInputChange)
            handleInputChange({ target: { value: transcriptText } } as any);
        };
    ...
    const startListening = () => recognition && setIsListening(true);
    const stopListening = () => recognition && setIsListening(false);
