...
export const LampContainer = ({
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-10 items-center justify-center isolate ">
        <motion.div
      ...
      <div className="relative flex -translate-y-16 flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
